                ...
                <div className='w-full relative z-40'>
                    <div class="container w-full px-5 pt-24 mx-auto">
                        <div class="flex flex-col text-center w-full">
                            <h2 class="text-xs mx-auto text-gray-900 tracking-widest font-bold title-font mb-3">ROOF PARTY POLAROI</h2>
                            <h1 class="sm:text-3xl text-2xl font-bold title-font mb-4"><span className='bg-yellow-400 text-white py-1 px-4 uppercase rounded-md'>Top Picks Deals  </span></h1>
                        </div>
                    </div>
                    <div class="py-10 grid grid-cols-12 gap-x-6 sm:grid-cols-12 px-5 bg-yellow-100">
                        {
                                        ...
                                        <div class="group relative">
                                            ...
                                            <div className='mt-1'>
                                                <h3 class="text-sm text-gray-700 flex flex-row justify-between items-center w-full">
                                                    ...
                                                    <p class="text-sm font-bold text-yellow-400">$35</p>
                                                </h3>
                                                ...
                                                <div className='mt-1 flex flex-row justify-between items-center w-full'>
                                                    <div className='text-xs font-bold text-gray-600 bg-yellow-300 py-1 px-2 rounded-sm'>Express</div>
